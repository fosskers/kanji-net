...
+ How many parents are in the same 級 as their children?
...
+ 異体字 pairs have to be linked together and counted in the same 級, without
  affecting the overall count. Example: 顚・顛
